    ...
    >
      <div class="relative mt-1">
        ...
        >
          <ComboboxOptions
            ref="popover"
            class="z-10 mt-1 absolute max-h-60 min-w-70 w-full overflow-auto rounded-md bg-white text-base shadow-lg ring-1 ring-black/5 focus:outline-none sm:text-sm pl-0"
          >
            <div

...
<AccordionGroup @open="accordionOpened">
  ...
  <!-- 🏢 Entreprise -->
  <h3 class="text-2xl font-bold text-gray-title mt-10 mb-4">Entreprise</h3>
  ...
  <Accordion title="Vous avez une question sur un organisme de formation ou une certification Qualiopi ?">
    ...
    <p>
      ...
      <a href="https://www.monactiviteformation.emploi.gouv.fr/" target="_blank">l'application Mon Activité Formation</a>.
    </p>
    <p class="mb-0">
  ...
  <h3 class="text-2xl font-bold text-gray-title mt-10 mb-4">Données foncières, cadastre et adresses</h3>
  ...
  <!-- ⚙️ APIs publiques -->
  <h3 class="text-2xl font-bold text-gray-title mt-10 mb-4">APIs publiques</h3>
  ...
  <!-- 📦 Autres données -->
  <h3 class="text-2xl font-bold text-gray-title mt-10 mb-4">Autres données</h3>
  ...
  <h3 class="text-2xl font-bold text-gray-title mt-10 mb-4">Autres questions fréquentes</h3>
  ...
  <Accordion title="Vous avez une question sur un titre de séjour ?">
    ...
    <ul class="list-disc pl-4">
      <li>
        <a href="https://www.service-public.fr/particuliers/vosdroits/N110" target="_blank">La fiche dédiée sur Service-Public.fr</a>
      </li>
      <li>
        <a href="https://www.refugies.info/demarche/5dc2da982e9859001680b8a2" target="_blank">Le site refugies.info</a>
      </li>
      <li>
        <a href="https://administration-etrangers-en-france.interieur.gouv.fr/particuliers/#/contact" target="_blank">Contacter le service compétent du Ministère de l'Intérieur</a>
      </li>
    </ul>
  </Accordion>
  <Accordion title="Vous avez un doute ou avez été victime de fraude ou d'escroquerie ?">
    ...
    <ul class="list-disc pl-4">
      <li>
        <a href="https://www.service-public.fr/particuliers/vosdroits/F1520" target="_blank">La fiche pratique escroquerie de Service-Public.fr</a>
      </li>
      <li>
        <a href="https://www.service-public.fr/particuliers/vosdroits/F34800" target="_blank">La fiche pratique phishing (hameçonnage) sur Service-Public.fr</a>
      </li>
      <li>
        <a href="https://www.cybermalveillance.gouv.fr/diagnostic/accueil" target="_blank">L’outil de diagnostic sur cybermalveillance.gouv.fr</a>
      </li>
    </ul>
  </Accordion>
  <Accordion title="Vous avez une question sur le compte professionnel de formation (CPF) ?">
    <p class="mb-0">
      Notre équipe n'est pas en mesure de vous aider sur ces questions. Vous pouvez vous référer à
      <a href="https://www.service-public.fr/particuliers/vosdroits/F10705" target="_blank">la fiche pratique sur Service-Public.fr</a>.
    </p>
  </Accordion>

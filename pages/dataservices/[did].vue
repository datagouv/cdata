          ...
          <div class="flex flex-col md:space-x-10 md:flex-row md:items-start">
            ...
            >
              ...
              >
                ...
                <DatasetQualityScore :score="dataservice.quality.score" />
              </section>
...
import { isOrganizationCertified, BrandedButton, DatasetQualityScore, LoadingBlock, OpenApiViewer, ReadMore, SimpleBanner, type Dataservice, AvatarWithName, useFormatDate, MarkdownViewer, getDescriptionShort } from '@datagouv/components-next'

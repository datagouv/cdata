...
describe('buildExplorerFeedbackUrl', () => {
  it('appends all six context params to the base URL', () => {
    const url = new URL(buildExplorerFeedbackUrl('https://tally.so/r/form', { dataset, resource, simplifiedUserAgent }))
  ...
  it('keeps query params already present in the base URL', () => {
    const url = new URL(buildExplorerFeedbackUrl('https://tally.so/r/form?source=banner', { dataset, resource, simplifiedUserAgent }))
  ...
  it('omits resource params when no resource is resolved yet', () => {
    const url = new URL(buildExplorerFeedbackUrl('https://tally.so/r/form', { dataset, resource: null, simplifiedUserAgent }))
  ...
  it('omits navigateur_appareil during SSR (no user agent)', () => {
    const url = new URL(buildExplorerFeedbackUrl('https://tally.so/r/form', { dataset, resource, simplifiedUserAgent: null }))
  ...
  it('returns the base URL unchanged when it is not a valid absolute URL', () => {
    expect(buildExplorerFeedbackUrl('/relative/path', { dataset, resource, simplifiedUserAgent })).toBe('/relative/path')
  })
})

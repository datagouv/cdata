import type { AccessTypeForm, WithAccessType, Dataset, CommunityResource, Dataservice, Reuse, User, Frequency, Organization, License, ReuseType, Resource, ContactPoint, Schema, PaginatedArray } from '@datagouv/components-next'
